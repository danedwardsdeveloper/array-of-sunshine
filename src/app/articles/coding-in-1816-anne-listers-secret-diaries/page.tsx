...
// [Anne
// 				Lister](https://en.wikipedia.org/wiki/Anne_Lister) (1791 - 1840) was
// 				from a minor landowning family, and is sometimes known as 'the first
// 				modern lesbian'. I had seen the BBC dramatisation of her fascinating
// 				life, [Gentleman
// 				Jack](https://www.metacritic.com/tv/gentleman-jack/), so I was
// 				immediately interested. I knew she had a strong personality,
// 				eccentric habits, a masculine appearance, and challenged the
// 				status-quo, but I didn't know that her diaries were partially
// 				written in code to conceal (amongst other things) her homosexuality.
// 				I bought a copy and finished it a week later. ### The Code Itself
...
// 				they were handled by the people who inherited them. ### Quick to
// 				crack; Slow to surface After Anne's death, the diaries remained
// 				untouched at her ancestral home, Shibden Hall, for over 50 years,
// 				until John Lister - who inherited the estate in the late 19th
// 				century - cracked the code with the help of a friend. The friend was
// 				so scandalised that he suggested burning the diaries, but John, as a
// 				lover of history with more respect for such an important resource,
// 				instead decided to publish a homophobe-friendly portion of the
// 				diaries in a local newspaper, and then hid the pages behind a panel
// 				at his hall, where they would remain until after his death in the
// 				1930s. Some years before he died, John had become bankrupt, but a
...
// 				### Helena Whitbread and full disclosure It wasn't until the
// 				mid-1980s that researcher Helena Whitbread discovered the diaries at
// 				the Shibden Hall archives. She meticulously transcribed and decoded
// 				the entire collection, finally bringing Anne Lister's story into the
// 				public view. This was a laborious endeavour, as the handwriting was
// 				very small, and the letters
// 				[cross-written](https://www.janeaustensummer.org/post/caught-in-the-cross-writing)
...
// 				Code as a shield Whatever the diaries reveal about Anne's psychology
// 				(She wanted to live with a female partner and spend quality time
// 				with her! Scandalous!!) they say a lot more about the unaccepting
// 				society she lived in. The content she chose to conceal exposes the
// 				harsh realities of her life as a lesbian in a time when
// 				homosexuality was socially unacceptable. She couldn't be openly gay,
// 				so her code functioned as a shield, allowing her to access to the
// 				therapeutic power of writing while protecting herself from
// 				persecution. This dispels the misconception that I had previously
// 				held, that female homosexuality was historically more tolerated than
// 				its male counterpart. The myth that Queen Victoria didn't explicitly
// 				criminalise lesbian sex because she didn't believe it occurred [is
// 				not
// 				true](https://www.open.edu/openlearn/society-politics-law/law/lesbianism-and-the-criminal-law-england-and-wales).
...
// 				diaries so plainly attest. ### What if she didn't write in code? I
// 				couldn't help but think: what would happen if Anne had simply
...
// 				cipher. **Beyond its historical significance, Anne Lister's coded
// 				diary serves as a testament to the enduring human desire for love
// 				and self-expression, whatever the constraints of the day. It's a
...
// 				still she couldn't live a truly authentic life. Helena Whitbread's
// 				edition is packed full of insights into the social and historical
// 				context in which Anne lived, and the diaries are a powerful story of
// 				a determined woman using her wits to navigate the rigid societal
