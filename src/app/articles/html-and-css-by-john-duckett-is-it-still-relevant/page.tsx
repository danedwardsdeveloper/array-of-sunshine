...
export default function Page() {
  return (
    <ArticleLayout article={article}>
      ...
      <p>
        However, I was pleasantly surprised by how relevant it all seemed, and it helped me to organise and
        solidify my existing understanding of these languages. The first working draft of HTML 5 was published
      ...
      <p>
        ...
        , <code>{'<section>'}</code>, <code>{'<aside>'}</code> and <code>{'<footer>'}</code>.
      </p>

      <h3>Flash player</h3>
      <p>
        Adobe Flash Player was a platform that enabled websites to play videos, which peaked in popularity
        around 2005 and 2010, but it is now{' '}
        <StyledLink
      ...
      <p>
        It has been superseded by the HTML <code>{'<video>'}</code> element and other video-hosting platforms,
        such as YouTube & Vimeo, that allow you to embed videos on a web page easily without hosting huge
        files and worrying about encoding.
      </p>

      <h3>Image formats</h3>
      <p>
        JPEG and PNG images are now being replaced on the web with WebP and AVIF. These file types offer
        better compression, which enables you to reduce the file size dramatically without losing too much
        quality. This, in turn, will make your sites load faster. WebP was developed by Google and currently
        has better browser support than AVIF.
      </p>
      ...
      <h3>960.gs</h3>
      <p>
        This CSS framework, referenced frequently throughout the book, allowed developers to use a grid layout
        system easily before CSS3 was widely supported. It was trendy in the early 2010s before features like
        Grid and Flexbox were introduced.
      </p>
      ...
      <p>
        These powerful features only emerged when the book was published, negating the need for many hacky
        workarounds, such as using <code>float</code> for layout and <code>inline-block</code> for horizontal
        alignment.
      </p>
      ...
      <h3>Media Queries</h3>
      <p>
        The introduction of more sophisticated media queries, with features like orientation and resolution
        detection, gives us even more fine-grained control over building responsive designs across various
        devices.
      </p>
      ...
      <p>
        Relative to the viewport size, these units simplified the creation of responsive layouts that scale
        proportionally with screen dimensions.
      </p>

      <h3>Variables (Custom Properties)</h3>
      <p>
        <strong>CSS Variables:</strong> Native variables in CSS allow you to define reusable values, making
        your stylesheets more dynamic and maintainable. This reduces repetition and eases style updates.
      </p>
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>
              <strong>CSS Transitions:</strong> Smoothly transition property changes over a set duration,
              creating simple animations on hover or other interactions without JavaScript.
            </li>
            <li>
              <strong>CSS Animations:</strong> More powerful control over animations with{' '}
              <code>@keyframes</code>, allowing you to define complex, multi-step animation sequences directly
        ...
        <li>
          ...
          <ul>
            <li>
              <strong>Calc Function:</strong> Allows calculations within CSS (e.g.,{' '}
              <code>width: calc(100% - 20px);</code> for dynamic sizing).
            </li>
            <li>
              <strong>Shapes:</strong> Features for creating basic geometric shapes (<code>circle</code>,{' '}
              <code>polygon</code>) with CSS.
            </li>
            <li>
              <strong>Filters and Blend Modes:</strong> Graphical effects like <code>blur</code>,{' '}
              <code>grayscale</code>, <code>drop-shadow</code>, and blend modes manipulate image and element
              appearance.
            </li>
          </ul>
        </li>
      ...
      <p>
        ...
        by Mike McGrath. Updated in 2020, this is a similar (weirdly almost identical in size and weight to
        the Duckett book) but much more up-to-date whistle-stop tour of the languages of web development.
      </p>
    </ArticleLayout>
  )
}
