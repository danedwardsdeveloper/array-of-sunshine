  ...
  return (
    <ArticleLayout article={article}>
      ...
      <p>
        ...
        <code>e</code> could mean <code>error</code>, <code>event</code>, or <code>evaluate</code>, so it can
        be confusing for someone (your future self included) reading your code.
      </p>
      <h3>For variables</h3>
