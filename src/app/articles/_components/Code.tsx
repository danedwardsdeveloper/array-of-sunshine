...
export const InlineCode = ({ children, ...props }: React.HTMLAttributes<HTMLElement>) => (
  <code
...
export const CodeBlock = ({
  ...
  return (
    <div data-component="CodeBlock" className="rounded-lg border border-gray-200 my-8">
      <div
        className={clsx(
      ...
      >
        ...
        <div className="flex items-center">
          <span className="text-base text-center text-gray-500 mr-2">{formatLanguage(language)}</span>
          <button
            onClick={handleCopyClick}
            aria-label="Copy code"
            className={clsx('flex items-center', 'rounded', 'hover:opacity-80')}
          >
