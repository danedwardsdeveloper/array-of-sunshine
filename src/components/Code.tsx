...
export const InlineCode = ({
	...
	<code
		className="border  border-gray-200 bg-gray-100 text-black rounded px-2 py-0.5 font-mono break-words"
		{...props}
	>
		{children}
	</code>
...
export const CodeBlock = ({
	...
	return (
		<div
			...
			className="rounded-lg border border-gray-200 my-8"
		>
			<div
				className={clsx(
			...
			<SyntaxHighlighter
				...
				className={clsx("overflow-x-auto rounded-b-md")}
				style={{
					...oneLight,
					'pre[class*="language-"]': {
