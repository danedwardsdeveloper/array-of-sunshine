...
import featuredImage from '@public/images/styling-checkboxes-in-react-and-next-with-tailwind.png'
import Checkbox from './Checkbox'

export const stylingCheckboxesInReactAndNextWithTailwind: Article = {
	publishedAt: createDate(13, september, 2024),
	displayTitle: 'Styling checkboxes in React and Next with Tailwind',
	metaTitle: 'Styling checkboxes in React and Next with Tailwind',
	metaDescription: 'Learn how to customize checkboxes in Tailwind CSS, including background, tick, and focus ring colours.',
...
/>
<label className="ms-2" htmlFor={\`checkbox-\${children}\`}>
  {children}
</label>
</div>
);
			...
			<p>Now we can add some colours to the checkboxes, though some of these are more confusing than you might think.</p>
			...
			<h3>Checked style</h3>
			<p>
				To change the colour of the negative space around the check mark, use a text colour style, such as <code>text-red-500</code>
			</p>
			<p>
