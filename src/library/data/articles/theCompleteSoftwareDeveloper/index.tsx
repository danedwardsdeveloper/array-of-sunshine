...
import featuredImage from '@public/images/complete-software-developers-career-guide-book-review-and-summary.png'
...
export const theCompleteSoftwareDeveloper: Article = {
	displayTitle: "The Complete Software Developer's Career Guide: book review and summary",
	metaTitle: "The Complete Software Developer's Career Guide book review",
	metaDescription: `Review of John Sonmez's "The Complete Software Developer's Career Guide" coding book - strengths, weaknesses, and key takeaways.`,
	publishedAt: createDate(21, september, 2024),
	...
	content: (
		<>
			<p>
				This book caught my attention because of its striking cover, and a quick flick through the table of contents intrigued me -
				especially the section on what to wear to programming job interviews and at the office.
			</p>
			<p>
        ...
        to tackling the challenges developers face.`}
			...
			<h3>Writing style</h3>
			<p>
				The author adopts a conversational tone throughout the book, making complex topics more digestible and engaging. This chatty style
				helps to break down barriers between the reader and the material, creating a more enjoyable reading experience.
			</p>
			<p>
				However, the writing can sometimes become repetitive, with key points being restated frequently. While this repetition may help
				reinforce essential concepts, some readers might find it unnecessary and potentially tedious.
			</p>
			<p>
				Humour is woven throughout the book, providing welcome relief from its often dry nature. Surprisingly, the chapter on DevOps stood
				out to me for its comedic content.
			</p>
			<h3>Book design</h3>
			<p>
        ...
        orange and white text on a black background creates a visually striking effect.`}
			...
			<p>
				Internally, the generous use of white space enhances readability and gives the book a premium feel. While the resulting size may be
				somewhat unwieldy, it also lends the book a sense of authority and comprehensiveness that many readers will appreciate.
			</p>
        ...
        some fiction.`}
			...
			<p>
				The book is physically massive - 19.05 x 4.57 x 23.5 cm (7.5 x 1.75 x 9.25 inches) and 1.361 kg (3 pounds). And while it is a long
				text (the audiobook is approximately 20 hours long, much longer than a typical 11 hours), I believe it could have been much smaller,
				with a more concise writing style and considerably less white space on the page (even though I appreciate this from a purely
        ...
        warning on the Amazon listing or his own website.`}
			...
			<p>
				Additionally, there are lots of links peppered throughout the book that need an explanation as to what they contain. If you saw this
				in print with no explanation, would you bother to type it out?
        ...
        they're worth including in a printed book.`}
			...
			<p>
				I found it frustrating to finally put away my laptop and settle down with a book, only to feel that I should be checking a link
				because it might be helpful or essential, but then get a tenuously relevant meme or photo.
			</p>
        ...
        wasn't surprised to see her clap back.`}
			...
			<p>
				Her argument was that the books have a small audience, take a very long time to write, must be tested thoroughly, and are out of
				date within a year or two. This makes a lot of sense to me.
			</p>
			<p>
        ...
        not true. Particularly annoying when the author used to be a `}
			...
			<p>
				Sure, anyone could post regular social media content, but pretty people are much more likely to have positive outcomes, making it
        ...
        typically pay much less than other divisions.`}
			...
			<p>
				When learning a new technology, get a broad overview before digging into details. Try watching a 100 Seconds YouTube video and
				searching for common difficulties using the technology before you get started.
			</p>
			<p>
				Setting your expectations about how long something will take and how difficult it will be can keep you motivated and help you
        ...
        look arrogant. And if you choose a low number, you look unskilled. There's no way to win.`}
			...
			<p>
				...
				<StyledLink href="https://www.joshwcomeau.com/effective-portfolio/" ariaLabel="Building an effective dev portfolio, free eBook">
					here
				</StyledLink>
				.
			</p>
        ...
        gym memberships, and technology stipends.`}
			...
			<p>
				These perks can significantly enhance your overall compensation package and job satisfaction while potentially costing the company
        ...
        time.`}
			...
			<p>
				When evaluating multiple job offers, looking beyond the base salary and calculating your effective hourly wage for an accurate
        ...
        of paid time off, which can significantly impact your work-life balance.`}
			...
			<p>
				Be careful when dealing with recruiters who might not have your best interests. Learn about the different types of recruiters in
				software to avoid getting burned.
			</p>
        ...
        on cash.`}
			...
			<p>
				If you have much other non-programming work experience, look for jobs that combine the two. Technology is used everywhere, so even
				if your previous career is very niche, there will probably be at least some opportunities to match. For example, I used to be a
				professional string arranger, so I could apply for jobs at sheet music publishing websites, companies that make notation software,
				etc., where they will appreciate my knowledge of code and music notation.
			</p>
        ...
        directly impacts a software project's long-term success and efficiency.`}
			...
			<AdditionalImage image={hundredSeconds} alt="Fireship YouTube channel is a great way to learn about new technology">
			...
			<p>
				Learn enough to call yourself a full-stack developer, then choose a speciality. Start by gaining broad knowledge across the full
				stack, from front-end to back-end technologies, databases, and DevOps.
			</p>
			<p>
        ...
        (measured with Chrome Lighthouse), while Squarespace does pretty badly.`}
			...
			<p>
				If you do know web development, something like a Next.js or Gatsby template is a great option. This blog is a Next template
				customised to include code blocks, images, and excellent SEO.
			</p>
			<h3>Choose a specialty</h3>
			<p>
				By focusing on a particular area, such as mobile app development, machine learning, or cybersecurity, you can position yourself as
				an expert in a high-demand niche.
			</p>
			<p>
				This specialisation allows you to develop deep knowledge and skills that set you apart from generalist developers. Employers often
				seek specialists to tackle complex, domain-specific challenges, which can lead to better job opportunities and higher salaries.
			</p>
