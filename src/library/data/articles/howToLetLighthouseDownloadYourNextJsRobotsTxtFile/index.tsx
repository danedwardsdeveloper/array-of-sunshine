...
import { january, tags } from '@/library/constants'
import { createDate } from '@/library/utilities'
import type { Article } from '@/types'
import featuredImage from '@public/images/how-to-let-lighthouse-download-your-next-js-robots-txt-file.png'
import perfectLighthouseScore from './perfect-lighthouse-scores.png'
import robotsShowsInBrowser from './robots-shows-in-browser.png'

export const howToLetLighthouseDownloadYourNextJsRobotsTxtFile: Article = {
	publishedAt: createDate(29, january, 2025),
	displayTitle: 'How to let Lighthouse download your Next.js robots.txt file',
	metaTitle: 'How to let Lighthouse download your Next.js robots.txt file',
	...
	content: (
        ...
        from your browser.`}
			...
			<p className="text-red-600 font-medium italic">Lighthouse was unable to download a robots.txt file.</p>
  ...
  return {
    rules: {
      ...
      allow: '/',
			...
			<p>
				You might find that while the file is accessible at <code>/robots.txt</code>
...
export default nextConfig`}</CodeBlock>
			...
			<ul>
				<li>
					It only modifies the CSP for the <code>robots.txt</code>
					{' route'}
				</li>
				<li>
					It only allows connections to your domain: <code>{`'self'`}</code>
				</li>
			...
			<p>By implementing this fix, you maintain both security and optimal Lighthouse performance for your Next.js application.</p>
