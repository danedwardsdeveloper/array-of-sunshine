...
import { createDate } from '@/library/utilities/definitions/createDate'
import type { Article } from '@/types'
import featuredImage from '../../../../../public/images/the-problem-with-codecademy.png'
import SchoolOfLifeBook from './what-they-forgot-to-teach-you-at-school-school-of-life-book.webp'

export const theProblemWithCodecademy: Article = {
	publishedAt: createDate(20, may, 2024),
	displayTitle: 'The problem with Codecademy',
	metaTitle: 'The problem with using Codecademy to learn to code',
	metaDescription: `The limitations of certificates and why it's crucial to focus on your personal goals rather than just completing courses.`,
	...
	content: (
        ...
        Their popularity is well-deserved. However, every tool has its limitations.`}
			...
			<p>
				The Full-Stack Pathway promises a shiny certificate at the end. Unfortunately, that certificate holds little weight in the job
				market - the real prize lies in developing your skills and building a strong portfolio. Think about it - would you rather interview
				someone with a generic certificate (that could easily be faked or bought) or someone whose portfolio showcases their ability to
				solve real-world problems using the technologies companies use on a daily basis?
			</p>

			<h3>Focus on your goals, not just completing the course</h3>
			<p>
				Inspired by this{' '}
				<StyledLink ariaLabel="You could finally leave school, THe School of Life" href="https://www.youtube.com/watch?v=pJhUs1L_RQo">
					School of Life YouTube video
				</StyledLink>{' '}
				and concepts explored further in the fabulous book{' '}
				<StyledLink ariaLabel="School of Life book on Amazon" href="https://www.amazon.co.uk/What-They-Forgot-Teach-School/dp/1912891395">
        ...
        happening for me.`}
			...
			<ul>
				<li>
					<strong>Lingering Student Mentality:</strong> Even after formal schooling ends, people may subconsciously crave external
					validation and approval from authority figures. They might feel a need to follow the rules set by others instead of pursuing their
					own path. But authority is not necessarily benign: schools and teachers are likely looking after their own needs more than they
					are yours.
				</li>
				<li>
					<strong>Questioning External Measures of Success:</strong> The School of Life criticises the idea that exams and grades are the
					ultimate measure of worth. They argue for finding your own internal sense of fulfilment rather than relying on external
					validation.
				</li>
				<li>
          ...
          perfect yet, and everything can always be improved.`}
			...
			<AdditionalImage image={SchoolOfLifeBook} alt="What they forgot to teach you at School, School of Life book" />
        ...
        to 90%, perhaps - here's what I'll be missing out:`}
          ...
          relevant to the jobs I want to apply for.`}
				...
				<li>
					<strong>Broken Assessments:</strong> Bug-infested assessments can be frustrating and a waste of time.
				</li>
				<li>
					<strong>Outdated Course Material:</strong> Codecademy can be slow to keep up with fast-paced technology (like React and Redux).
					Learning from official documentation might be less user-friendly, but the content is more relevant.
				</li>
				<li>
