...
import { august, tags } from '@/library/constants'
import { createDate } from '@/library/utilities'
import type { Article } from '@/types'
import featuredImage from '@public/images/resolving-vite-react-mime-type-errors.png'

export const resolvingViteReactMimeTypeErrors: Article = {
	publishedAt: createDate(1, august, 2024),
	displayTitle: 'Resolving Vite MIME type errors in React',
	metaTitle: 'How to resolve Vite React MIME type errors in React',
	metaDescription: `Learn how to fix MIME type errors in React, including the "not executable", "application/octet-stream", and "text/html" issues.`,
...
└── index.html`}
			...
			<p>The most common cause of these errors is really annoyingly simple, which is what motivated me to write this article.</p>

			<CodeBlock fileName="Console error" language="plaintext" disableLineNumbers>
				{'index-fWGo7SiS.js:1 Failed to load module'}
			</CodeBlock>

			<p className="call-out-green">
				If you encounter a MIME type error in the console referencing a specific file, e.g., <code>App.tsx:1</code>, search your entire
				codebase for instances where you (or your IDE) might have unintentionally added the <code>.tsx</code>, <code>.tsx</code>, or{' '}
				<code>.ts</code>
				extensions to your imports.
			</p>

			<p>
				In Visual Studio Code, use <code>Shift Command F</code> on a Mac, or <code>Shift Ctrl F</code> on Windows to perform a project-wide
				search.
			</p>

			<p>
				{`I love using Vite - it's fantastic and well-maintained (`}
				<code>create-react-app</code> was depreciated on June 23, 2023). Still, these errors could be avoided altogether if import file
				extensions were enforced. Other frameworks like Next.js do enforce this using ESLint.
			</p>
...
export default function App() {
    // Your component logic here
			...
			<p>
				By understanding these common issues and following best practices for file extensions, you can avoid MIME type errors in your React
				applications.
			</p>
		</>
	),
